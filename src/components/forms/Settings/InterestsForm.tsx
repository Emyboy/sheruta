...
import { Box, Button, VStack, Wrap, WrapItem, Text, Flex } from "@chakra-ui/react";
                        ...
                        <>
                            {interestsList.map((interest) => (
                                <WrapItem
                                    ...
                                    p="2"
                                >
                                    <EachOption label={interest.title} onClick={() => handleSelect(interest)} isActive={selectedInterests.some((h) => h.id === interest.id)} />
                                </WrapItem>
                            ))}
