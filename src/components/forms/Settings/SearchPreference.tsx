...
import { Box, FormControl, FormLabel, Select, Button, VStack, Text, useColorMode } from '@chakra-ui/react';
...
const SearchPreferenceForm = () => {
    ...
    useEffect(() => {
        if (locations.length > 0 && selectedLocation) {
            const locationObj: LocationKeywordData | undefined = locations.find((loc: LocationKeywordData) => loc.id === selectedLocation)
