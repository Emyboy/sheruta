...
export default function ProfilePictureSelector ({ done }: { done?: () => void }) {
	...
	return <Flex flexDir={'column'} justifyContent={'center'} alignItems={'center'}>
		...
		<Flex justifyContent={'center'}>
			<Flex bg={'brand'} h={'170px'} w={'170px'} rounded={'full'} my={10} p={1} alignItems={'center'} justifyContent={'center'}>
				<Flex bg={'black'} h={'full'} w={'full'} border={'1px'} rounded={'full'} my={10} alignItems={'center'} justifyContent={'center'} color={'text_muted'}>
					<BiCamera size={50} />
				</Flex>
			</Flex>
		</Flex>
