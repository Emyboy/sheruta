...
import { saveProfileDocs, getProfile, saveProfileSnippetDocs } from '@/firebase/service/userProfile/user-profile'
...
<Text
              ...
              Close
						...
						<Button color="brand" type={'submit'} fontSize={'14px'} mr={5} onClick={update} isLoading={isLoading}>
							Promote
						</Button>
					</ModalFooter>
				</ModalContent>
