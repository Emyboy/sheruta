...
interface NotificationContextType {
    ...
    getBookmarkStatusAndId : (objectId: string) => Promise<{ isBookmarked: boolean; bookmarkId: string | null }>
    updateBookmark: ({ objectType, objectRef }: { objectType: BookmarkType, objectRef: DocumentReference }) => Promise<void>
...
export const BookmarksProvider: React.FC<{ children: ReactNode }> = ({
    ...
    const updateBookmark = async ({ objectType, objectRef }: {
    ...
    const getBookmarkStatusAndId = async (objectId: string): Promise<{ isBookmarked: boolean; bookmarkId: string | null }> => {
        try {
            if (!user || !user._id) {
